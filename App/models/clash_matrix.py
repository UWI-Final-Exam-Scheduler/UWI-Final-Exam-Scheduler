...
class ClashMatrix(db.Model):
    ...
    courseCode1 = db.relationship('Course', foreign_keys=[course1], back_populates='clash_course1')
    courseCode2 = db.relationship('Course', foreign_keys=[course2], back_populates='clash_course2')
